...
void Environnement::comparaisonIndiceSommet ()// vulnaribilit� comparaison d'indice
{
    HANDLE console;
...
// on calcule la difference entre le premiere indice et le nouveau modifi�, puis on calcule le pourcentage de variation en l'affichant dans la conso
